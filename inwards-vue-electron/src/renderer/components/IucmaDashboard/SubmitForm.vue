            ...
            <div class="col-sm-6">
                <div class="col-sm-12">
                  ...
                  <div class="col-sm-12">
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                             <multiselect :options="stations" v-model="selectedStations" :multiple="false"></multiselect>
                        </div>       
                  </div>
                  <div class="col-sm-12">
                  ...
                  <div class="col-sm-12">
                    <div class="form-group">
                        <multiselect :options="gaugeHeights" v-model="selectedGaugeHeight" :multiple="false" @input="fetchDischarge()"></multiselect>
                    </div>
                  </div>
                  <div class="col-sm-12">
