...
export default {
  ...
  mounted() {
    axios
      .get(
        'https://inwards.award.org.za/app_json/wq_dash/rqos/compliance_table.php?stations=X2I050&sd=1972-12-10&ed=2023-11-28&type=0&variable=Cn_Diss_Water&unit=mg%2FL&merge=true&type=Rivers'
      )
      .then((response) => {
